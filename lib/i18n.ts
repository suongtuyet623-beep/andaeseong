...
export const ui: Record<Locale, UiStrings> = {
  vi: {
    ...
    pressPrefix: "Bài báo",
    pressAccent: "về tôi",
    pressSubtitle: "Những bài báo viết về hành trình chạy đua của mình tại Hàn Quốc.",
  ...
  ko: {
    ...
    pressPrefix: "",
    pressAccent: "신문",
    pressSubtitle: "저에 대한 신문 기사 모음입니다.",
    connectPrefix: "나와",
    connectAccent: "함께하기",
  ...
  en: {
    ...
    navPress: "Newspaper",
    pressPrefix: "",
    pressAccent: "Newspaper",
    pressSubtitle: "Newspaper articles about my running journey.",
